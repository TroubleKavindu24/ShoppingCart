    ...
    fun openDialog(){
        ...
        addBtn.setOnClickListener{
            ...
            if(itemName.isNotEmpty() && itemPrice.isNotEmpty() && itemQuantity.isNotEmpty()){
                ...
                Toast.makeText(applicationContext, "Product added success", Toast.LENGTH_SHORT).show()
                cartRVAdapter.notifyDataSetChanged()
                dialog.dismiss()
            }else{
                Toast.makeText(applicationContext, "Product not added", Toast.LENGTH_SHORT).show()
            }
        }
